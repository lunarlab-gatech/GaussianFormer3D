...
class NuScenesDataset(Dataset):
    ...
    def _sample_augmentation(self):
        ...
        fH, fW = self.data_aug_conf["final_dim"] # 864, 1600
    ...
    def __getitem__(self, index):
        ...
        if 'pts_filename' in input_dict:
            return_dict['pts_filename'] = input_dict['pts_filename']
        return return_dict
    ...
    def get_data_info(self, info):
        ...
        # Get the ego2lidar transformation matrix
        ...
        # Get the ego2global transformation matrix
        ...
        input_dict =dict(
            ...
            occ_path=info["occ_path"],  # for occ3d annotation
        ...
        if "token" in info['data']['LIDAR_TOP']:
            input_dict["lidar_token"] = info['data']['LIDAR_TOP']['token']
